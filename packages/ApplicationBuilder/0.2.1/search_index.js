...

{
    ...
    "title": "Compatibility",
    "category": "section",
    "text": "ApplicationBuilder supports macOS, Windows, and Linux on julia v0.6 and julia v0.7. Currently, ApplicationBuilder doesn\'t do cross-compilation, so to compile for Windows, you need to run it from a Windows machine, etc."
},
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "ApplicationBuilder.ApplicationBuilderApplicationBuilder.build_app_bundleApplicationBuilder.evalApplicationBuilder.include"
},
