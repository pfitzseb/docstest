...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "Install ArrayFire library: either download a binary from the official site, or you can build from source.In Julia v0.5 and v0.6:Pkg.add(\"ArrayFire\")In Julia v0.7:] add ArrayFire"
},
