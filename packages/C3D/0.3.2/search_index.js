...
{
    "location": "autodocs/#C3D.readc3dinfo",
    "page": "Docstrings",
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "C3D.AbstractParameterC3D.ArrayParameterC3D.BEC3D.C3DC3D.C3DFileC3D.EndianC3D.GroupC3D.HeaderC3D.LEC3D.ParameterTypeErrorC3D.ScalarParameterC3D.StringParameterC3D.ValidateErrorC3D._readarrayparameterC3D._readparamsC3D._readscalarparameterC3D.bitsformatC3D.descriptivesC3D.evalC3D.includeC3D.pointsigncheckC3D.ranalogC3D.ratescaleC3D.readc3dC3D.readc3dinfoC3D.readdataC3D.readgroupC3D.readheaderC3D.readparamC3D.readparamsC3D.rforceplatfC3D.rgroupsC3D.rpointC3D.safereadC3D.saferead!C3D.validate"
},
