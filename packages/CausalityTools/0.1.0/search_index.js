...

{
    ...
    "category": "section",
    "text": "The package is equally well-suited both for the study of causal directionality for experimental data, and for studying dynamical systems from a more formal context. The workflow integrates nicely with DynamicalSystems.jl.Check out the documentation (coming) for more information!"
},

{
    ...
    "category": "section",
    "text": "CausalityTools.jl brings together the following packages into one environment:package functionality version build\nStateSpaceReconstruction.jl Fully flexible state space reconstructions (embeddings), partitioning routines (variable-width rectangular, and triangulations), and partition refinement (equal-volume splitting of  simplices). 0.2.3 (Image: Build Status)\nTimeseriesSurrogates.jl Generate surrogate data from time series. 0.2.1 (Image: Build Status)\nTransferEntropy.jl Transfer entropy estimators. 0.2.3 (Image: Build Status)\nPerronFrobenius.jl Transfer (Perron-Frobenius) operator estimators. 0.1.3 (Image: Build Status)\nSimplices.jl Exact simplex intersections in N dimensions. 0.2.1 (Image: Build Status)"
},
