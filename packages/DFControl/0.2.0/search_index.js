...
{
    "location": "job/#DFControl.addcalc!-Tuple{DFJob,Array{#s2092,1} where #s2092<:(NTuple{4,T} where T),Vararg{Any,N} where N}",
    "page": "Job",
    "title": "DFControl.addcalc!",
    "category": "method",
...
{
    "location": "job/#DFControl.flag-Tuple{DFJob,Array{#s2094,1} where #s2094<:DFInput,Symbol}",
    "page": "Job",
...
{
    "location": "job/#DFControl.rmflags!-Tuple{DFJob,Array{#s2092,1} where #s2092<:DFInput,Vararg{Any,N} where N}",
    "page": "Job",
...
{
    "location": "job/#DFControl.setatoms!-Tuple{DFJob,Array{#s2092,1} where #s2092<:DFControl.AbstractAtom}",
    "page": "Job",
...
{
    "location": "job/#DFControl.setdata!-Tuple{DFJob,Array{#s2092,1} where #s2092<:DFInput,Symbol,Any}",
    "page": "Job",
...
{
    "location": "job/#DFControl.setflags!-Tuple{DFJob,Array{#s2088,1} where #s2088<:DFInput,Vararg{Any,N} where N}",
    "page": "Job",
