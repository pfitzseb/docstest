...
{
    "location": "autodocs/#Deldir.@allocate",
    "page": "Docstrings",
    "title": "Deldir.@allocate",
    "category": "macro",
    "text": "allocate()\n\nAllocate input to be modified by the deldir Fortran routine\n\n\n\n\n\n"
},

{
    "location": "autodocs/#Deldir.@error_handling",
    "page": "Docstrings",
    "title": "Deldir.@error_handling",
    "category": "macro",
    "text": "error_handling()\n\nHandle errors from the deldir Fortran routine\n\n\n\n\n\n"
},

{
    "location": "autodocs/#Deldir.@finalize",
    "page": "Docstrings",
    "title": "Deldir.@finalize",
    "category": "macro",
    "text": "finalize()\n\nProcess output from the deldir Fortran routine\n\n\n\n\n\n"
},

{
    "location": "autodocs/#Deldir.@initialize",
    "page": "Docstrings",
    "title": "Deldir.@initialize",
    "category": "macro",
    "text": "initialize()\n\nSet up input for the deldir Fortran routine\n\n\n\n\n\n"
},

{
    "location": "autodocs/#Deldir.deldir",
    "page": "Docstrings",
    "title": "Deldir.deldir",
    "category": "function",
...
{
    "location": "autodocs/#Deldir.edges",
    "page": "Docstrings",
    "title": "Deldir.edges",
    "category": "function",
...
{
    "location": "autodocs/#Deldir.remove_duplicates",
    "page": "Docstrings",
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "Deldir.@allocateDeldir.@error_handlingDeldir.@finalizeDeldir.@initializeDeldir.DelDirDeldir.DeldirDeldir.deldirDeldir.deldirwrapperDeldir.edgesDeldir.evalDeldir.includeDeldir.libdeldirDeldir.remove_duplicatesDeldir.voronoiarea"
},
