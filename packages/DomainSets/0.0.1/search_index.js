...
{
    "location": "autodocs/#DomainSets._product_eltype",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.affine_composition",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.apply_inverse",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.cartesianproduct",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.convert_space",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.default_tolerance",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.demote",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.element",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.elements",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.ellipse",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.ellipse_shape",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.embedded",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.embedding",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.interval_map",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.isomorphic",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.isomorphism",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.isomorphism_reduction",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.issubspace",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.left_inverse",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.linear_map",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.numelements",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.origin",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.promote_space",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.promotes_to",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.restrict_space",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.return_type",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.right_inverse",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.scaling_map",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.similar_interval",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.similar_space",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.simplify_product_eltype",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.spaceof",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.spacetype",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.subeltype",
    "page": "Docstrings",
    "title": "DomainSets.subeltype",
    "category": "function",
    "text": "Some geometric spaces have an eltype that is composed in terms of an underlying eltype. For example, Complex{Float64} and SVector{2,Float64} are based on Float64, which is their subeltype.\n\n\n\n\n\nIf the type T is a container type, the elements of T may have a different subeltype. If T is not a container, subeltype simply evaluates to T.\n\n\n\n\n\n"
},

{
    "location": "autodocs/#DomainSets.supereltype",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DomainSets.superspace",
    "page": "Docstrings",
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "DomainSets...DomainSets.AbstractAffineMapDomainSets.AbstractConstantMapDomainSets.AbstractHyperSphereDomainSets.AbstractIntervalDomainSets.AbstractMapDomainSets.AffineMapDomainSets.AngleMapDomainSets.AnyEmptySpaceDomainSets.AnyFullSpaceDomainSets.AnySpaceDomainSets.ArraySpaceDomainSets.BidirectionalMappedDomainDomainSets.CartToPolarMapDomainSets.ChebyshevIntervalDomainSets.ClosedFixedIntervalDomainSets.ClosedIntervalDomainSets.ComplexSpaceDomainSets.CompositeJacobianDomainSets.CompositeMapDomainSets.ConstantMapDomainSets.CubeDomainSets.DerivedDomainDomainSets.DifferenceDomainDomainSets.DomainDomainSets.Domain1dDomainSets.Domain2dDomainSets.Domain3dDomainSets.Domain4dDomainSets.DomainSetsDomainSets.EmbeddingMapDomainSets.EmptySpaceDomainSets.EuclideanDomainDomainSets.EuclideanSpaceDomainSets.FalseDomainSets.FixedIntervalDomainSets.ForwardMappedDomainDomainSets.FullSpaceDomainSets.GSpaceDomainSets.GeometricSpaceDomainSets.HalfLineDomainSets.IdentityMapDomainSets.IntegerSpaceDomainSets.IntersectionDomainDomainSets.IntervalDomainSets.InverseMappedDomainDomainSets.IsomorphismMapDomainSets.LinearMapDomainSets.MappedDomainDomainSets.MappedIntervalDomainSets.NegativeHalfLineDomainSets.OpenIntervalDomainSets.PointDomainSets.PolarToCartMapDomainSets.ProductDomainDomainSets.ProductMapDomainSets.ProductSpaceDomainSets.RationalSpaceDomainSets.RealSpaceDomainSets.RestrictionMapDomainSets.SimplexDomainSets.TranslatedDomainDomainSets.TranslationDomainSets.TrueDomainSets.TypeFactoryDomainSets.UnionDomainDomainSets.UnitBallDomainSets.UnitCircleDomainSets.UnitCircleMapDomainSets.UnitDiskDomainSets.UnitHyperBallDomainSets.UnitHyperSphereDomainSets.UnitIntervalDomainSets.UnitSimplexDomainSets.UnitSphereDomainSets.UnityMapDomainSets.VectorSpaceDomainSets.ZeroMapDomainSets._applymapDomainSets._approx_indomainDomainSets._convert_space_via_reductionDomainSets._duplicate_reduction_resultDomainSets._embedding_reductionDomainSets._embedding_via_promotionDomainSets._embedding_via_reductionDomainSets._inDomainSets._indomainDomainSets._product_eltypeDomainSets._promote_via_embedding_reductionDomainSets._promote_via_embedding_reduction1DomainSets._promote_via_embedding_reduction2DomainSets._promote_via_isomorphism_reductionDomainSets._promote_via_promotionDomainSets._promotes_toDomainSets._restrict_space_via_reductionDomainSets._restrict_spaces1DomainSets._return_typeDomainSets._widenDomainSets.affine_compositionDomainSets.apply_inverseDomainSets.apply_left_inverseDomainSets.apply_right_inverseDomainSets.applymapDomainSets.applymap_recDomainSets.approx_inDomainSets.approx_indomainDomainSets.boundaryDomainSets.cardinalityDomainSets.cartesianproductDomainSets.codomaintypeDomainSets.constantDomainSets.convert_spaceDomainSets.convert_space_via_promotionDomainSets.convert_space_via_reductionDomainSets.convert_space_via_superspaceDomainSets.convert_spacesDomainSets.cylinderDomainSets.default_toleranceDomainSets.demoteDomainSets.dimensionDomainSets.dimension_typeDomainSets.domainDomainSets.domain_spaceDomainSets.domaintypeDomainSets.elementDomainSets.elementsDomainSets.ellipseDomainSets.ellipse_shapeDomainSets.embeddedDomainSets.embeddingDomainSets.embedding_mapDomainSets.embedding_reductionDomainSets.embedding_via_promotionDomainSets.embedding_via_reductionDomainSets.embedding_via_superspaceDomainSets.emptyspaceDomainSets.euclideanspaceDomainSets.evalDomainSets.forward_mapDomainSets.forwardmap_domainDomainSets.gradientDomainSets.imageDomainSets.includeDomainSets.indomainDomainSets.infimumDomainSets.internal_eltypeDomainSets.interval_mapDomainSets.inverse_mapDomainSets.inversemap_domainDomainSets.isclosedDomainSets.iscompactDomainSets.isleftopenDomainSets.islinearDomainSets.isomorphicDomainSets.isomorphismDomainSets.isomorphism_mapDomainSets.isomorphism_reductionDomainSets.isomorphism_reduction_resultDomainSets.isrightopenDomainSets.issubspaceDomainSets.jac_typeDomainSets.jacobianDomainSets.lcdDomainSets.left_inverseDomainSets.leftendpointDomainSets.linear_mapDomainSets.linearizeDomainSets.map_update_eltypeDomainSets.matrixDomainSets.numelementsDomainSets.one_ofDomainSets.originDomainSets.parameterizationDomainSets.point_in_domainDomainSets.product_eltypeDomainSets.promote_spaceDomainSets.promote_space_typeDomainSets.promote_via_embedding_reductionDomainSets.promote_via_isomorphism_reductionDomainSets.promote_via_promotionDomainSets.promote_via_superspaceDomainSets.promotes_toDomainSets.rangeDomainSets.range_spaceDomainSets.restrict_spaceDomainSets.restrict_space_via_promotionDomainSets.restrict_space_via_reductionDomainSets.restrict_space_via_superspaceDomainSets.restrict_spaces1DomainSets.restrict_spaces2DomainSets.restriction_mapDomainSets.resultDomainSets.return_typeDomainSets.right_inverseDomainSets.rightendpointDomainSets.rotateDomainSets.rotation_mapDomainSets.rotationmatrixDomainSets.scaling_mapDomainSets.similar_intervalDomainSets.similar_spaceDomainSets.simplify_product_eltypeDomainSets.sourceDomainSets.spaceofDomainSets.spacetypeDomainSets.subeltypeDomainSets.superdomainDomainSets.supereltypeDomainSets.superspaceDomainSets.superspaceofDomainSets.supremumDomainSets.targetDomainSets.tensorproductDomainSets.translation_mapDomainSets.update_eltypeDomainSets.vDomainSets.vectorDomainSets.ℂDomainSets.ℚDomainSets.ℝDomainSets.ℝ1DomainSets.ℝ2DomainSets.ℝ3DomainSets.ℝ4DomainSets.ℤDomainSets.↪DomainSets.∂DomainSets.∘DomainSets.≅"
},
