...

{
    ...
    "title": "News",
    "category": "section",
    "text": "06/19/2018: The testing is at the moment intentionally crippled in order to assist with debugging of a Julia 0.7-alpha issue.It is always possible to run the tests manually, for instance include(\"test/test_miscellaneous.jl\").06/08/2018: FinEtools is now a registered package. The release 0.3.0 works with Julia 0.7.0-alpha. The notebook examples still need updating for 0.7.Past news"
},

{
    ...
    "title": "Get FinEtools",
    "category": "section",
    "text": "This package is  registered, and hence one can do just] add FinEtoolsOnly version 0.7 (including the nightly) builds of Julia  are supported. "
},
...

{
    ...
    "category": "section",
    "text": "The package comes with examples  of its use. Tutorials in notebook form are available and more will  be added in the near future.The documentation  is published as Github pages.  A use-case package explaining how to integrate FinEtools with  the user\'s own code is available here.(Image: Alt Visualization of sample result)"
},
...

{
    ...
    "category": "function",
    "text": "Jacobianmdim(self::IntegData{T}, J::FFltMat,\n  loc::FFltMat, conn::CC,\n  N::FFltMat, m::FInt)::FFlt where {T<:FESet0Manifold, CC}\n\nEvaluate the manifold Jacobian for an m-dimensional manifold.\n\nFor an 0-dimensional finite element,  the manifold Jacobian is for     m=0: +1     m=1: Jacobiancurve     m=2: Jacobiansurface     m=3: Jacobianvolume\n\n\n\n\n\nJacobianmdim(self::IntegData{T}, J::FFltMat,\nloc::FFltMat, conn::CC,\nN::FFltMat, m::FInt)::FFlt where {T<:FESet1Manifold, CC}\n\nEvaluate the manifold Jacobian for an m-dimensional manifold.\n\nFor an 1-dimensional finite element,  the manifold Jacobian is for     m=1: Jacobiancurve     m=2: Jacobiansurface     m=3: Jacobianvolume\n\n\n\n\n\nJacobianmdim(self::IntegData{T}, J::FFltMat,\n            loc::FFltMat, conn::CC,\n            N::FFltMat, m::FInt)::FFlt where {T<:FESet2Manifold, CC}\n\nEvaluate the manifold Jacobian for an m-dimensional manifold.\n\nFor an 2-dimensional finite element,  the manifold Jacobian is for     m=2: Jacobiansurface     m=3: Jacobianvolume\n\n\n\n\n\nJacobianmdim{T<:FESet3Manifold}(self::IntegData, J::FFltMat,\n            loc::FFltMat, conn::FIntMat, N::FFltMat, m::FInt)\n\nEvaluate the manifold Jacobian for an m-dimensional manifold.\n\nFor an 3-dimensional cell,  the manifold Jacobian is     m=3: Jacobianvolume\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "map2parametric(self::T, x::FFltMat, pt::FFltVec;\n    Tolerance = 0.001, maxiter =5) where {T<:FESet}\n\nMap a spatial location to parametric coordinates.\n\nx=array of spatial coordinates of the nodes, size(x) = nbfuns x dim, c= spatial location Returns success = Boolean flag, true if successful, false otherwise. pc = Returns a row array of parametric coordinates if the solution was successful, otherwise NaN are returned.\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "meshboundary(fes::T) where {T<:FESet}\n\nExtract the boundary finite elements from a mesh.\n\nExtract the finite elements of manifold dimension (n-1) from the supplied list of finite elements of manifold dimension (n).\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "nstressstrain(::Type{DeforModelRed})::FInt\n\nHow many stress components involved in the balance equation (and how many strain components) are there for each model reduction type?\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "phun(str::String; system_of_units = :SI, base_time_units = :SEC)\n\nEvaluate an expression in  physical units.\n\nExample\n\npu = ustring -> phun(ustring; systemofunits = :SIMM) E1s = 130.0pu(\"GPa\") yields 1.3e+5 (in mega Pascal) whereas 130.0phun(\"GPa\"; systemofunits = :SI) yields 1.3e+11 (in Pascal)\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "renumberconn!(fes::FESet, new_numbering::FIntVec)\n\nRenumber the nodes in the connectivity of the finite elements based on a new numbering for the nodes.\n\nfes =finite element set newnumbering = new serial numbers for the nodes.  The connectivity           should be changed as conn[j] –> newnumbering(conn[j])\n\nLet us say there are nodes not connected to any finite element that you would like to remove from the mesh: here is how that would be accomplished. % connected = findunconnnodes(fens, fes); fens, newnumbering =compactfens(fens, connected); fes = renumberconn!(fes, newnumbering); % Finally, check that the mesh is valid: validate_mesh(fens, fes);\n\n\n\n\n\n"
},
