...

{
    ...
    "title": "News",
    "category": "section",
    "text": "09/20/2018: Separated out examples and tutorials from the FinEtools library itself.\n09/02/2018: Updated all examples for Julia 1.0.\n08/24/2018: Updated all tutorials for Julia 1.0, using the Literate workflow.\n08/23/2018: Added support for NICE (nodally-integrated continuum elements) tetrahedral four-node finite elements.Past news"
},
...

{
    ...
    "category": "function",
    "text": "map2parametric(self::T, x::FFltMat, pt::FFltVec;\n    tolerance = 0.001, maxiter =5) where {T<:FESet}\n\nMap a spatial location to parametric coordinates.\n\nx=array of spatial coordinates of the nodes, size(x) = nbfuns x dim, c= spatial location tolerance = tolerance in parametric coordinates; default is 0.001. Returns success = Boolean flag, true if successful, false otherwise. pc = Returns a row array of parametric coordinates if the solution was successful, otherwise NaN are returned.\n\n\n\n\n\n"
},
