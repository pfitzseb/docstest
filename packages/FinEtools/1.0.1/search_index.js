...

{
    ...
    "title": "News",
    "category": "section",
    "text": "11/09/2018: The name IntegData was changed to IntegDomain to better reflect the meaning of this type. Since this is an incompatible change, v1.0.0 tag was released.\n10/02/2018: The code-coverage computation seems to be broken. The coverage in the FinEtools package hasn\'t actually changed and it is still at 98%.Past news"
},
...

{
    ...
    "category": "type",
    "text": "FEMMHeatDiff(integdomain::IntegDomain{S, F}, material::M) where {S<:FESet, F<:Function, M<:MatHeatDiff}\n\nConstruct with the default orientation matrix (identity).  \n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#FinEtools.MeshTriangleModule.T3annulus",
    "page": "Docstrings",
    "title": "FinEtools.MeshTriangleModule.T3annulus",
    "category": "function",
    "text": "T3annulus(rin::FFlt, rex::FFlt, nr::FInt, nc::FInt, Angl::FFlt, orientation::Symbol=:a)\n\nMesh of an annulus segment.\n\nMesh of an annulus segment, centered at the origin, with internal radius rin, and  external radius rex, and  development angle Angl (in radians). Divided into elements: nr, nc in the radial and circumferential direction respectively.\n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#FinEtools.MeshTriangleModule.T6annulus",
    "page": "Docstrings",
    "title": "FinEtools.MeshTriangleModule.T6annulus",
    "category": "function",
    "text": "T6annulus(rin::FFlt, rex::FFlt, nr::FInt, nc::FInt, Angl::FFlt, orientation::Symbol=:a)\n\nMesh of an annulus segment.\n\nMesh of an annulus segment, centered at the origin, with internal radius rin, and  external radius rex, and  development angle Angl (in radians). Divided into elements: nr, nc in the radial and circumferential direction respectively.\n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#FinEtools.FEMMHeatDiffModule.energy",
    "page": "Docstrings",
    "title": "FinEtools.FEMMHeatDiffModule.energy",
    "category": "function",
    "text": "energy(self::FEMMHeatDiff, geom::NodalField{FFlt},  temp::NodalField{FFlt})\n\nCompute the \"energy\" integral over the interior domain.\n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#FinEtools.IntegDomainModule.otherdimensionunity",
    "page": "Docstrings",
    "title": "FinEtools.IntegDomainModule.otherdimensionunity",
    "category": "function",
