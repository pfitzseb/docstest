...

{
    ...
    "category": "type",
    "text": "StackChannel{T}(sz::Int)\n\nConstructs a Channel with an internal buffer that can hold a maximum of sz objects of type T. put! calls on a full StackChannel block until an object is removed with take!. Channel(0) constructs an unbuffered StackChannel. put! blocks until a matching take! is called. And vice-versa. Other constructors:\n\nChannel(Inf): equivalent to Channel{Any}(typemax(Int))\nChannel(sz): equivalent to Channel{Any}(sz)\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "isready(c::StackChannel)\n\nDetermine whether a Channel has a value stored to it. Returns immediately, does not block. For unbuffered StackChannels returns true if there are tasks waiting on a put!.\n\n\n\n\n\n"
},
