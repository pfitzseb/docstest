...
{
    "location": "autodocs/#GitHub.@api_default",
    "page": "Docstrings",
    "title": "GitHub.@api_default",
    "category": "macro",
    "text": "For a method taking an API argument, add a new method without the API argument that just calls the method with DEFAULT_API.\n\n\n\n\n\n"
},
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "GitHub.@api_defaultGitHub.AnonymousAuthGitHub.AppGitHub.AuthorizationGitHub.BlobGitHub.BranchGitHub.COMMENT_EVENTSGitHub.CheckRunGitHub.ChecksGitHub.CommentGitHub.CommentListenerGitHub.CommitGitHub.ContentGitHub.DEFAULT_APIGitHub.ENTROPYGitHub.EventListenerGitHub.GistGitHub.GitCommitGitHub.GitHubGitHub.GitHubAPIGitHub.GitHubTypeGitHub.GitHubWebAPIGitHub.InstallationGitHub.IssueGitHub.JWTAuthGitHub.OAuth2GitHub.OwnerGitHub.PullRequestGitHub.RNGGitHub.ReferenceGitHub.RepoGitHub.ReviewGitHub.StatusGitHub.TagGitHub.TeamGitHub.TreeGitHub.UsernamePassAuthGitHub.WebhookGitHub.WebhookEventGitHub.__init__GitHub.add_collaboratorGitHub.api_uriGitHub.appGitHub.authenticateGitHub.authenticate_headers!GitHub.base64_to_base64urlGitHub.blobGitHub.branchGitHub.branchesGitHub.build_content_responseGitHub.check_membershipGitHub.chopzGitHub.close_pull_requestGitHub.collaboratorsGitHub.commentGitHub.commentsGitHub.commitGitHub.commitsGitHub.content_uriGitHub.contributorsGitHub.create_access_tokenGitHub.create_blobGitHub.create_check_runGitHub.create_commentGitHub.create_fileGitHub.create_forkGitHub.create_gistGitHub.create_gist_forkGitHub.create_gitcommitGitHub.create_issueGitHub.create_pull_requestGitHub.create_referenceGitHub.create_repoGitHub.create_statusGitHub.create_tagGitHub.create_treeGitHub.create_webhookGitHub.delete_commentGitHub.delete_fileGitHub.delete_gistGitHub.delete_referenceGitHub.directoryGitHub.dismiss_reviewGitHub.edit_commentGitHub.edit_gistGitHub.edit_issueGitHub.evalGitHub.event_from_payload!GitHub.event_headerGitHub.extract_nullableGitHub.extract_page_urlGitHub.fileGitHub.find_page_linkGitHub.followersGitHub.followingGitHub.forksGitHub.from_valid_repoGitHub.get_page_linksGitHub.gh_deleteGitHub.gh_delete_jsonGitHub.gh_getGitHub.gh_get_jsonGitHub.gh_get_paged_jsonGitHub.gh_patchGitHub.gh_patch_jsonGitHub.gh_postGitHub.gh_post_jsonGitHub.gh_putGitHub.gh_put_jsonGitHub.gistGitHub.gist_forksGitHub.gistsGitHub.gitcommitGitHub.github2jsonGitHub.github_paged_getGitHub.github_requestGitHub.handle_commentGitHub.handle_event_requestGitHub.handle_response_errorGitHub.has_event_headerGitHub.has_page_linksGitHub.has_sig_headerGitHub.has_valid_secretGitHub.includeGitHub.installationsGitHub.is_valid_eventGitHub.iscollaboratorGitHub.isorgGitHub.issueGitHub.issuesGitHub.json2githubGitHub.kind_err_strGitHub.membersGitHub.nameGitHub.namefieldGitHub.orgsGitHub.ownerGitHub.permalinkGitHub.prune_github_valueGitHub.pubkeysGitHub.pull_requestGitHub.pull_requestsGitHub.rate_limitGitHub.readmeGitHub.referecesGitHub.referenceGitHub.referencesGitHub.remove_collaboratorGitHub.reply_toGitHub.repoGitHub.reposGitHub.reviewsGitHub.sig_headerGitHub.starGitHub.star_gistGitHub.stargazersGitHub.starredGitHub.starred_gistsGitHub.statsGitHub.statusGitHub.statusesGitHub.tagGitHub.teamsGitHub.treeGitHub.typprefixGitHub.unstarGitHub.unstar_gistGitHub.unwatchGitHub.unwrap_union_typesGitHub.update_check_runGitHub.update_fileGitHub.update_pull_requestGitHub.update_referenceGitHub.usersGitHub.watchGitHub.watchedGitHub.watchers"
},
