...

{
    ...
    "category": "section",
    "text": "Separators may be combined using the operators ! (complement), ∩ and ∪ to make more complicated sets; see the notebook for several examples. Further examples can be found in the repository IntervalConstraintProgrammingNotebooks."
},
