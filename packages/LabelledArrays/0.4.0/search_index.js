...
{
    "location": "autodocs/#LabelledArrays.@LArray",
    "page": "Docstrings",
    "title": "LabelledArrays.@LArray",
    "category": "macro",
    "text": "@LArray Eltype Size Names\n@LArray Values Names\n\nCreates an LArray with names determined from the Names vector and values determined from the Values array. Otherwise, and eltype and size are used to make an LArray with undefined values.\n\nFor example:\n\na = @LArray Float64 (2,2) (:a,:b,:c,:d)\nb = @LArray [1,2,3] (:a,:b,:c)\n\n\n\n\n\n"
},

{
    "location": "autodocs/#LabelledArrays.@LVector",
    "page": "Docstrings",
    "title": "LabelledArrays.@LVector",
    "category": "macro",
    "text": "@LVector Type Names\n\nCreates an LArray of dimension 1 with eltype and undefined values. Length is via the number of names given.\n\nFor example:\n\nb = @LVector [1,2,3] (:a,:b,:c)\n\n\n\n\n\n"
},

{
    "location": "autodocs/#LabelledArrays.@SLArray",
    "page": "Docstrings",
    "title": "LabelledArrays.@SLArray",
    "category": "macro",
    "text": "@SLArray Size Names\n@SLArray Eltype Size Names\n\nCreates an anonymous function that builds a labelled static vector with eltype ElType with names determined from the Names with size Size. If no eltype is given, then the eltype is determined from the arguments in the constructor.\n\nFor example:\n\nABC = @SLArray (2,2) (:a,:b,:c,:d)\nx = ABC(1.0,2.5,3.0,5.0)\nx.a == 1.0\nx.b == 2.5\nx.c == x[3]\nx.d == x[2,2]\n\n\n\n\n\n"
},

{
    "location": "autodocs/#LabelledArrays.@SLVector",
    "page": "Docstrings",
    "title": "LabelledArrays.@SLVector",
    "category": "macro",
    "text": "@SLVector Names\n@SLVector Eltype Names\n\nCreates an anonymous function that builds a labelled static vector with eltype ElementType with names determined from the Names. If no eltype is given, then the eltype is determined from the values in the constructor.\n\nFor example:\n\nABC = @SLVector (:a,:b,:c)\nx = ABC(1.0,2.5,3.0)\nx.a == 1.0\nx.b == 2.5\nx.c == x[3]\n\n\n\n\n\n"
},

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "LabelledArrays.@LArrayLabelledArrays.@LVectorLabelledArrays.@SLArrayLabelledArrays.@SLVectorLabelledArrays.DisplayCellLabelledArrays.LAStyleLabelledArrays.LArrayLabelledArrays.LVectorLabelledArrays.LabelledArraysLabelledArrays.SLArrayLabelledArrays.SLVectorLabelledArrays.evalLabelledArrays.includeLabelledArrays.symnames"
},
