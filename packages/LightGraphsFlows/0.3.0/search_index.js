...
{
    "location": "#LightGraphsFlows.jl:-flow-algorithms-for-LightGraphs-1",
    "page": "Getting started",
...
{
    "location": "maxflow/#LightGraphsFlows.boykov_kolmogorov_impl",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.discharge!",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.enqueue_vertex!-Tuple{AbstractArray{T,1} where T,Integer,AbstractArray{Bool,1},AbstractArray{T,1} where T}",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.gap!",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.push_flow!",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.relabel!",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.blocking_flow!",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.blocking_flow-Tuple{LightGraphs.AbstractGraph,Integer,Integer,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Maxflow algorithms",
    "title": "LightGraphsFlows.blocking_flow",
    "category": "method",
...
{
    "location": "maxflow/#LightGraphsFlows.dinic_impl",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.augment_path!-Union{Tuple{T}, Tuple{Array{Int64,1},AbstractArray{T,2},AbstractArray{T,2} where T}} where T",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.edmonds_karp_impl",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#LightGraphsFlows.fetch_path",
    "page": "Maxflow algorithms",
...
{
    "location": "maxflow/#Max-flow-algorithms-1",
    "page": "Maxflow algorithms",
...
{
    "location": "multiroute/#LightGraphsFlows.multiroute_flow-Union{Tuple{T}, Tuple{R}, Tuple{AbstractGraph,Integer,Integer}, Tuple{AbstractGraph,Integer,Integer,AbstractArray{T,2}}} where T where R<:Real",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.ExtendedMultirouteFlowAlgorithm",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.KishimotoAlgorithm",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.approximately_equal-Union{Tuple{T}, Tuple{Tuple{T,T},Tuple{T,T}}} where T<:AbstractFloat",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.breakingPoints",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.emrf",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.intersection-Union{Tuple{T}, Tuple{I}, Tuple{R}, Tuple{Array{Tuple{T,T,I},1},R}} where T<:AbstractFloat where I<:Integer where R<:Real",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.intersection-Union{Tuple{T}, Tuple{R}, Tuple{T,T,Integer,T,T,R}} where T<:AbstractFloat where R<:Real",
    "page": "Multiroute flows",
    "title": "LightGraphsFlows.intersection",
    "category": "method",
...
{
    "location": "multiroute/#LightGraphsFlows.minmaxCapacity-Union{Tuple{AbstractArray{T,2}}, Tuple{T}} where T",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.slope",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.AbstractMultirouteFlowAlgorithm",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#LightGraphsFlows.kishimoto",
    "page": "Multiroute flows",
...
{
    "location": "multiroute/#Multi-route-flow-1",
    "page": "Multiroute flows",
...
{
    "location": "mincost/#Min-cost-flow-1",
    "page": "Min-cost flows",
    "title": "Min-cost flow",
    "category": "section",
    "text": "Modules = [LightGraphsFlows]\nPages = [\"mincost.jl\"]\nOrder = [:function, :type]"
...
{
    "location": "mincut/#LightGraphsFlows.mincut-Tuple{LightGraphs.SimpleGraphs.SimpleDiGraph,Integer,Integer,AbstractArray{T,2} where T,LightGraphsFlows.AbstractFlowAlgorithm}",
    "page": "Min-cut",
