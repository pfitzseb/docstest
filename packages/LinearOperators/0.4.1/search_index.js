...

{
    ...
    "category": "section",
    "text": "Operators can be transposed (A.\'), conjugated (conj(A)) and conjugate-transposed (A\'). Operators can be sliced (A[:,3], A[2:4,1:5], A[1,1]), but unlike matrices, slices always return operators (see differences below)."
},
...
{
    "location": "autodocs/#LinearOperators.full",
    "page": "Docstrings",
    "title": "LinearOperators.full",
    "category": "function",
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "LinearOperators.A_mul_B!LinearOperators.AbstractLinearOperatorLinearOperators.Ac_mul_B!LinearOperators.At_mul_B!LinearOperators.InverseLBFGSOperatorLinearOperators.LBFGSDataLinearOperators.LBFGSOperatorLinearOperators.LSR1DataLinearOperators.LSR1OperatorLinearOperators.LinearOperatorLinearOperators.LinearOperatorExceptionLinearOperators.LinearOperatorIndexTypeLinearOperators.LinearOperatorsLinearOperators.OperatorOrMatrixLinearOperators.check_ctransposeLinearOperators.check_hermitianLinearOperators.check_positive_definiteLinearOperators.evalLinearOperators.fullLinearOperators.hermitianLinearOperators.includeLinearOperators.ishermitianLinearOperators.issymmetricLinearOperators.opCholeskyLinearOperators.opDiagonalLinearOperators.opExtensionLinearOperators.opEyeLinearOperators.opHermitianLinearOperators.opHouseholderLinearOperators.opInverseLinearOperators.opLDLLinearOperators.opOnesLinearOperators.opRestrictionLinearOperators.opZerosLinearOperators.reset!LinearOperators.shapeLinearOperators.symmetric"
},
