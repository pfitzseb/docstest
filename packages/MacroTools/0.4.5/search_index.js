...
{
    "location": "#",
    "page": "Introduction to MacroTools",
    "title": "Introduction to MacroTools",
    "category": "page",
    "text": ""
},

{
    ...
    "title": "MacroTools.jl",
    "category": "section",
    "text": "A library provides helpful tools for writing macros, notably a very simple but powerful templating system and some functions that have proven useful to me."
},
...
{
    "location": "#MacroTools.@esc-Tuple",
    "page": "Introduction to MacroTools",
    "title": "MacroTools.@esc",
    "category": "macro",
    "text": "@esc x y\n\nis the same as\n\nx = esc(x)\ny = esc(y)\n\n\n\n\n\n"
},

{
    "location": "#MacroTools.@expand-Tuple{Any}",
    "page": "Introduction to MacroTools",
    "title": "MacroTools.@expand",
    "category": "macro",
    "text": "More convenient macro expansion, e.g.\n\n@expand @time foo()\n\n\n\n\n\n"
},

{
    "location": "#MacroTools.inexpr-Tuple{Any,Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.isdef-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.isexpr-Tuple{Expr}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.namify-Tuple{Symbol}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.prettify-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.rmlines-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.splitarg-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.splitdef-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.unblock-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.alias_gensyms-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.assoc!-Tuple{Any,Any,Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.combinearg-NTuple{4,Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.combinedef-Tuple{Dict}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.gatherwheres-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.gensym_ids-Tuple{Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.postwalk-Tuple{Any,Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#MacroTools.prewalk-Tuple{Any,Any}",
    "page": "Introduction to MacroTools",
...
{
    "location": "#Function-and-Macros-1",
    "page": "Introduction to MacroTools",
    "title": "Function and Macros",
    "category": "section",
    "text": "Modules = [MacroTools]\nOrder = [:module, :constant, :type, :macro, :function]"
},
