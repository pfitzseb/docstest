...

{
    ...
    "title": "Octo.jl",
    "category": "section",
    "text": "Documentation Build Status\n[![][docs-latest-img]][docs-latest-url] [![][travis-img]][travis-url] [![][appveyor-img]][appveyor-url] [![][codecov-img]][codecov-url]Octo.jl 🐙 is an SQL Query DSL in Julia (https://julialang.org).It\'s influenced by Ecto (https://github.com/elixir-ecto/ecto)."
},
