...

{
    ...
    "category": "type",
    "text": "Product of two manifolds {P = (x1,x2), x1 ∈ m1, x2 ∈ m2}. P is stored as a flat 1D array, and x1 is before x2 in memory. Use get_inner(m, x, {1,2}) to access x1 and x2 in their original format.\n\n\n\n\n\n"
},
