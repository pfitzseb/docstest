...
{
    "location": "autodocs/#PackageCompiler.ExitHooksStart",
    "page": "Docstrings",
    "title": "PackageCompiler.ExitHooksStart",
    "category": "function",
    "text": "Exit hooks can get serialized and therefore end up in weird behaviour When incrementally compiling\n\n\n\n\n\n"
},

{
    "location": "autodocs/#PackageCompiler.InitBase",
    "page": "Docstrings",
    "title": "PackageCompiler.InitBase",
    "category": "function",
    "text": "Init basic C libraries\n\n\n\n\n\n"
},

{
    "location": "autodocs/#PackageCompiler.InitREPL",
    "page": "Docstrings",
    "title": "PackageCompiler.InitREPL",
    "category": "function",
    "text": "Initialize REPL module for Docs\n\n\n\n\n\n"
},

{
    "location": "autodocs/#PackageCompiler.PrecompileCommand",
    "page": "Docstrings",
    "title": "PackageCompiler.PrecompileCommand",
    "category": "function",
    "text": "The command to pass to julia –output-o, that runs the julia code in path during compilation.\n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#PackageCompiler.jl_flag_value",
    "page": "Docstrings",
    "title": "PackageCompiler.jl_flag_value",
    "category": "function",
    "text": "extract_flag(flag, jl_cmd = Base.julia_cmd())\n\nExtracts the value for flag from jl_cmd.\n\n\n\n\n\n"
},
...
{
    "location": "autodocs/#PackageCompiler.run_julia",
    "page": "Docstrings",
    "title": "PackageCompiler.run_julia",
    "category": "function",
    "text": "run_julia(\n    code::String;\n    g = nothing, O = nothing, output_o = nothing, J = nothing,\n    startup_file = \"no\"\n)\n\nRun code in a julia command. You can overwrite any julia command line flag by setting it to a value. If the flag has the value nothing, the value of the flag of the current julia process is used.\n\n\n\n\n\n"
},

{
    "location": "autodocs/#PackageCompiler.static_julia",
    "page": "Docstrings",
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "PackageCompiler.ExitHooksEndPackageCompiler.ExitHooksStartPackageCompiler.IncludePackageCompiler.InitBasePackageCompiler.InitREPLPackageCompiler.PackageCompilerPackageCompiler.PrecompileCommandPackageCompiler.allflagsPackageCompiler.build_execPackageCompiler.build_executablePackageCompiler.build_julia_cmdPackageCompiler.build_objectPackageCompiler.build_sharedPackageCompiler.build_shared_libPackageCompiler.build_sysimgPackageCompiler.cflagsPackageCompiler.compile_incrementalPackageCompiler.compile_packagePackageCompiler.compile_system_imagePackageCompiler.copy_files_arrayPackageCompiler.copy_julia_libsPackageCompiler.copy_system_imagePackageCompiler.create_project_from_requirePackageCompiler.current_systemimagePackageCompiler.default_sysimg_pathPackageCompiler.depsfilePackageCompiler.evalPackageCompiler.executable_extPackageCompiler.flag_to_jloptionsPackageCompiler.flags_with_cmdvalPackageCompiler.force_native_image!PackageCompiler.gccPackageCompiler.gccworksPackageCompiler.get_backup!PackageCompiler.get_root_dirPackageCompiler.includePackageCompiler.includeDirPackageCompiler.is_short_flagPackageCompiler.jl_commandPackageCompiler.jl_flag_valuePackageCompiler.jl_option_keyPackageCompiler.jl_option_valuePackageCompiler.jl_options_to_flagPackageCompiler.julia_code_cmdPackageCompiler.julia_cpu_targetPackageCompiler.julia_flagsPackageCompiler.ldflagsPackageCompiler.ldlibsPackageCompiler.libDirPackageCompiler.package_folderPackageCompiler.package_tomlPackageCompiler.packages_from_requirePackageCompiler.private_libDirPackageCompiler.push_command!PackageCompiler.remove_temp_filesPackageCompiler.revertPackageCompiler.run_PATHPackageCompiler.run_juliaPackageCompiler.shell_escapePackageCompiler.short_flag_to_jloptionsPackageCompiler.snoopPackageCompiler.snoop_packagesPackageCompiler.static_juliaPackageCompiler.sysimage_binariesPackageCompiler.sysimg_folderPackageCompiler.sysimgbackup_folderPackageCompiler.system_compilerPackageCompiler.threadingOnPackageCompiler.to_cmd_valPackageCompiler.write_toml"
},
