...
{
    "location": "#PowerDynBase.GridDynamics-Tuple{AbstractArray{#s33,1} where #s33<:AbstractNodeParameters,Vararg{Any,N} where N}",
    "page": "-",
    "title": "PowerDynBase.GridDynamics",
    "category": "method",
...
{
    "location": "#PowerDynBase.GridDynamics-Tuple{AbstractArray{#s33,N} where N where #s33<:PowerDynBase.AbstractNodeDynamics,AbstractArray{T,2} where T}",
    "page": "-",
    "title": "PowerDynBase.GridDynamics",
    "category": "method",
...
{
    "location": "#Base.promote_rule-Tuple{Type{#s35} where #s35<:OrdinaryNodeDynamics,Type{#s34} where #s34<:OrdinaryNodeDynamicsWithMass}",
    "page": "-",
...
{
    "location": "#PowerDynBase.differentials-Tuple{AbstractArray{#s596,1} where #s596<:PowerDynBase.AbstractAlgebraicNodeDynamics}",
    "page": "-",
...
{
    "location": "#PowerDynBase._GridDynamics-Tuple{AbstractArray{#s596,1} where #s596<:OrdinaryNodeDynamics,AbstractArray{T,2} where T}",
    "page": "-",
...
{
    "location": "#PowerDynBase.internal_unitranges-Tuple{AbstractArray{#s596,1} where #s596<:PowerDynBase.AbstractNodeDynamics}",
    "page": "-",
...
{
    "location": "#PowerDynBase.total_nint-Tuple{AbstractArray{#s596,1} where #s596<:PowerDynBase.AbstractNodeDynamics}",
    "page": "-",
...
{
    "location": "#PowerDynBase.total_nvars-Tuple{AbstractArray{#s596,1} where #s596<:PowerDynBase.AbstractNodeDynamics}",
    "page": "-",
...
{
    "location": "#PowerDynOperationPoint.RootFunction",
    "page": "-",
    "title": "PowerDynOperationPoint.RootFunction",
    "category": "type",
    "text": "struct RootFunction\n    grid::GridDynamics\nend\n\nBasic data structure providing a method to evalute a subtype of PowerDynBase.GridDynamics as a right-hand-side function that can be used for root searching.\n\n\n\n\n\n"
},

{
    "location": "#PowerDynOperationPoint.RootFunction-Tuple{AbstractArray{T,1} where T}",
    "page": "-",
    "title": "PowerDynOperationPoint.RootFunction",
    "category": "method",
    "text": "function (r::RootFunction)(x_in)\n\nEvaluate the power grid dynamics of r for x_in and return the result.\n\n\n\n\n\n"
},

{
    "location": "#PowerDynOperationPoint.RootFunction-Tuple{Any,Any}",
    "page": "-",
    "title": "PowerDynOperationPoint.RootFunction",
    "category": "method",
    "text": "function (r::RootFunction)(x_out, x_in)\n\nEvaluate the power grid dynamics of r for x_in and write it in x_out.\n\n\n\n\n\n"
},

{
    "location": "#PowerDynOperationPoint.getOperationPoint-Union{Tuple{AbstractState{G,V,T}}, Tuple{T}, Tuple{V}, Tuple{G}} where T where V where G",
    "page": "-",
    "title": "PowerDynOperationPoint.getOperationPoint",
    "category": "method",
    "text": "function operationpoint(start::AbstractState)\nfunction operationpoint(grid::GridDynamics, start)\n\nFind the operation point (fixed point of the right-hand-side) of a power grid (either grid or inferred) by using the initial value start.\n\n\n\n\n\n"
},

{
    "location": "#PowerDynOperationPoint.OperationPointError",
    "page": "-",
    "title": "PowerDynOperationPoint.OperationPointError",
    "category": "type",
    "text": "Error to be thrown if something goes wrong during the operation point search.\n\n\n\n\n\n"
},

{
    ...
    "title": "-",
    "category": "page",
    "text": "Modules = [PowerDynBase, PowerDynOperationPoint]"
},
