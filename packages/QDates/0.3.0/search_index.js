...

{
    ...
    "title": "QDates",
    "category": "section",
    "text": "(Image: Build Status) (Image: Build status)  (Image: Cirrus)   (Image: Coverage Status) (Image: codecov.io)The QDates package provides Japanese \"Kyūreki (旧暦)\" calendrical calculations into Julia.   \"Kyūreki (旧暦)\" is one of the Lunisolar Calendar that has been once used in Japan."
},

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "To install the release version, simply run on the Julia Pkg REPL-mode:pkg> add QDatesTo install the latest development version, run the following command instead:pkg> add QDates#masterThen you can run the built-in unit tests withpkg> test QDatesto verify that everything is functioning properly on your machine."
},
...

{
    ...
    "title": "Limitations",
    "category": "section",
    "text": "Year range is 445-2200. QDate(2201) throws ArgumentError."
},

{
    ...
    "title": "Credits",
    "category": "section",
    "text": "QDates.jl is created by @antimon2 (Shunsuke GOTOH)."
},

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "QDates.DAYS_OFFSETQDates.FIRST_VALUEQDates.FIRST_YEARQDates.ISQDAYOFWEEKQDates.LAST_VALUEQDates.LAST_YEARQDates.QDateQDates.QDatesQDates.QREFQDates._DAYS_IN_MONTH_FQDates._check_instantQDates._ciQDates.date2jdnQDates.dayQDates.dayabbrQDates.daynameQDates.dayofweekQDates.dayofyearQDates.daysQDates.daysinmonthQDates.daysinyearQDates.evalQDates.firstdayofmonthQDates.firstdayofyearQDates.includeQDates.isleapmonthQDates.isleapyearQDates.is仏滅QDates.is先勝QDates.is先負QDates.is友引QDates.is大安QDates.is赤口QDates.jdn2dateQDates.jdn2qdateQDates.lastdayofmonthQDates.lastdayofyearQDates.leap_prefixQDates.monthQDates.monthabbrQDates.monthdayQDates.monthleapdayQDates.monthnameQDates.monthsinyearQDates.qdate2jdnQDates.qdaysofweekQDates.qmonthsQDates.todayQDates.yearQDates.yearmonthQDates.yearmonthdayQDates.yearmonthleapQDates.yearmonthleapdayQDates.仏滅QDates.先勝QDates.先負QDates.卯月QDates.友引QDates.大安QDates.如月QDates.師走QDates.弥生QDates.文月QDates.水無月QDates.皐月QDates.睦月QDates.神無月QDates.葉月QDates.赤口QDates.長月QDates.霜月"
},
