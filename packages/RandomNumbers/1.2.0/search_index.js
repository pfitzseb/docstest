...

{
    ...
    "title": "Installation",
    "category": "section",
    "text": "This package is registered. The stable version of this package requires Julia 0.7+. You can install it by:(v1.1) pkg> add RandomNumbersIt is recommended to run the test suites before using the package:(v1.0) pkg> test RandomNumbers"
},
