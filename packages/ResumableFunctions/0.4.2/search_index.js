...
{
    "location": "manual/#Two-way-communication-1",
    "page": "Manual",
...
{
    "location": "manual/#Iterator-interface-1",
    "page": "Manual",
...
{
    "location": "manual/#Parametric-@resumable-functions-1",
    "page": "Manual",
...
{
    "location": "internals/#Split-the-definition-1",
    "page": "Internals",
...
{
    "location": "internals/#For-loops-1",
    "page": "Internals",
    "title": "For loops",
    "category": "section",
...
{
    "location": "internals/#Type-definition-1",
    "page": "Internals",
...
{
    "location": "internals/#Call-definition-1",
    "page": "Internals",
...
{
    "location": "internals/#Transformation-of-the-body-1",
    "page": "Internals",
...
{
    "location": "internals/#Renaming-of-slots-1",
    "page": "Internals",
...
{
    "location": "internals/#Two-way-communication-1",
    "page": "Internals",
    "title": "Two-way communication",
    "category": "section",
...
{
    "location": "internals/#Exception-handling-1",
    "page": "Internals",
...
{
    "location": "internals/#Try-catch-finally-end-block-handling-1",
    "page": "Internals",
...
{
    "location": "internals/#Yield-transformation-1",
    "page": "Internals",
...
{
    "location": "internals/#Dispatch-mechanism-1",
    "page": "Internals",
...
{
    "location": "internals/#Making-the-type-callable-1",
    "page": "Internals",
...
{
    "location": "library/#ResumableFunctions.ResumableFunctions",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.@resumable-Tuple{Expr}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.@yield",
    "page": "Library",
...
{
    "location": "library/#Public-interface-1",
    "page": "Library",
...
{
    "location": "library/#Base.IteratorSize-Union{Tuple{Type{T}}, Tuple{T}} where T<:ResumableFunctions.FiniteStateMachineIterator",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.BoxedUInt8",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.FiniteStateMachineIterator",
    "page": "Library",
...
{
    "location": "library/#Base.eltype-Union{Tuple{Type{T}}, Tuple{T}, Tuple{R}} where T<:ResumableFunctions.FiniteStateMachineIterator{R} where R",
    "page": "Library",
    "title": "Base.eltype",
    "category": "method",
...
{
    "location": "library/#ResumableFunctions._is_yield-Tuple{Any}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.get_args-Tuple{Dict}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.get_param_name-Tuple{Any}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.get_slots-Tuple{Dict,Dict{Symbol,Any},Module}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.hasreturnvalue-Tuple{Any}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.make_arg_any-Tuple{Any,Dict{Symbol,Any}}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.make_args-Tuple{Dict}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.remove_catch_exc-Tuple{Any,Dict{Symbol,Any}}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_arg-Tuple{Any}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_exc-Tuple{Any}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_for-Tuple{Any,ResumableFunctions.BoxedUInt8}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_let-Tuple{Any,Set{Symbol}}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_slots-Tuple{Any,Base.KeySet{Symbol,Dict{Symbol,Any}}}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_slots_let-Tuple{Expr,Base.KeySet{Symbol,Dict{Symbol,Any}}}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_try-Tuple{Any,ResumableFunctions.BoxedUInt8}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_yield-Tuple{Any,ResumableFunctions.BoxedUInt8}",
    "page": "Library",
...
{
    "location": "library/#ResumableFunctions.transform_yield-Tuple{Any}",
    "page": "Library",
    "title": "ResumableFunctions.transform_yield",
    "category": "method",
    "text": "Function that replaces a @yield ret or @yield statement with \n\n  return ret\n\n\n\n\n\n"
