...
{
    "location": "funcs/#Simplices.orientation-Union{Tuple{Array{T,2}}, Tuple{T}} where T<:Number",
    "page": "Function reference",
    "title": "Simplices.orientation",
    "category": "method",
    "text": "orientation(simplex::AbstractArray{T, 2}) where {T<:Number} -> Float64\n\nCompute orientation of a simplex, represented by a Array{Float64, 2} of size (dim+1)-by-dim.\n\n\n\n\n\n"
},
...
{
    "location": "funcs/#Simplices.radius-Union{Tuple{Array{T,2}}, Tuple{T}} where T<:Number",
    "page": "Function reference",
    "title": "Simplices.radius",
    "category": "method",
    "text": "radius(s::AbstractArray{T, 2}) where {T<:Number} -> Float64\n\nCompute radius of a simplex s, represented by a Array{Float64, 2} of size (dim+1)-by-dim.\n\n\n\n\n\n"
},

{
    "location": "funcs/#Simplices.radius-Union{Tuple{T}, Tuple{Array{T,2},Array{T,2}}} where T<:Number",
    "page": "Function reference",
    "title": "Simplices.radius",
    "category": "method",
