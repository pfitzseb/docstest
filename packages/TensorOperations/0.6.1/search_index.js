...

{
    ...
    "category": "section",
    "text": "(Image: TensorOperations) (Image: Build Status) (Image: License) (Image: Coverage Status) (Image: codecov.io)Fast tensor operations using a convenient index notation."
},

{
    ...
    "title": "What\'s new",
    "category": "section",
    "text": "Addition of a @tensoropt macro that will optimize the contraction order of any product of tensors A[...]*B[...]*C[...]*... (see below for usage instructions and this paper for more details).\nThe @tensor macro will reorganize the contraction order of the so-called NCON style of specifying indices is respected, i.e. all contracted indices are labelled by positive integers and all uncontracted indices are specified by negative integers. In that case, tensors will be contracted in such an order that indices with smaller integer label willbe contracted firstBetter overall type stability, both in the @tensor(opt) environment and with the function based approach. Even the simple function based syntax can now be made type stable by specifing the indices using tuples.\nFully compatible with Julia v0.6 (v0.5 no longer supported); compatible (but with deprecation warnings) with julia v0.7-rc1."
},
...

{
    ...
    "title": "Docstrings",
    "category": "page",
    "text": "TensorOperations.@dividebodyTensorOperations.@optimalcontractiontreeTensorOperations.@stridedloopsTensorOperations.@tensorTensorOperations.@tensoroptTensorOperations.AbstractPolyTensorOperations.BASELENGTHTensorOperations.ConjugatedStridedDataTensorOperations.IndexErrorTensorOperations.IndexTupleTensorOperations.NormalStridedDataTensorOperations.OneTensorOperations.PolyTensorOperations.PowerTensorOperations.StaticLengthTensorOperations.StridedDataTensorOperations.StridedSubArrayTensorOperations.TensorOperationsTensorOperations.ZeroTensorOperations._dividebodyTensorOperations._filterdimsTensorOperations._findfirstTensorOperations._findlastTensorOperations._findnextTensorOperations._indmaxTensorOperations._intersectTensorOperations._isemptysetTensorOperations._memjumpsTensorOperations._ncontree!TensorOperations._oneTensorOperations._optimaltreeTensorOperations._permuteTensorOperations._scale!TensorOperations._setdiffTensorOperations._sreplaceTensorOperations._stridedloopsTensorOperations._unionTensorOperations._zeroTensorOperations.add!TensorOperations.add_indicesTensorOperations.add_micro!TensorOperations.add_rec!TensorOperations.add_stridesTensorOperations.axpbyTensorOperations.checkindicesTensorOperations.computecostTensorOperations.connectedcomponentsTensorOperations.contract!TensorOperations.contract_indicesTensorOperations.contract_micro!TensorOperations.contract_rec!TensorOperations.contract_stridesTensorOperations.degreeTensorOperations.deindexifyTensorOperations.deindexify!TensorOperations.evalTensorOperations.getallindicesTensorOperations.getindicesTensorOperations.getlhsrhsTensorOperations.hastraceindicesTensorOperations.includeTensorOperations.isassignmentTensorOperations.isdefinitionTensorOperations.isgeneraltensorTensorOperations.isindexTensorOperations.isnconstyleTensorOperations.isscalarexprTensorOperations.istensorTensorOperations.istensorexprTensorOperations.makegeneraltensorTensorOperations.makeindexTensorOperations.makescalarTensorOperations.maketensorTensorOperations.memjumpsTensorOperations.ncontreeTensorOperations.numindTensorOperations.optdataTensorOperations.optimaltreeTensorOperations.parsecostTensorOperations.primeTensorOperations.processcontractorderTensorOperations.rangeexprTensorOperations.scalarTensorOperations.similar_from_indicesTensorOperations.storesetTensorOperations.tensoraddTensorOperations.tensoradd!TensorOperations.tensorcontractTensorOperations.tensorcontract!TensorOperations.tensorcopyTensorOperations.tensorcopy!TensorOperations.tensorifyTensorOperations.tensorproductTensorOperations.tensorproduct!TensorOperations.tensortraceTensorOperations.tensortrace!TensorOperations.tinvpermTensorOperations.trace!TensorOperations.trace_indicesTensorOperations.trace_micro!TensorOperations.trace_rec!TensorOperations.trace_stridesTensorOperations.tree2exprTensorOperations.tsetdiffTensorOperations.tuniqueTensorOperations.unique2"
},
