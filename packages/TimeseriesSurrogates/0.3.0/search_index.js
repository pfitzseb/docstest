...
{
    "location": "#TimeseriesSurrogates.jl-1",
    "page": "Overview",
...
{
    "location": "#I\'m-new-to-surrogate-testing-1",
    "page": "Overview",
...
{
    "location": "#I\'m-experienced-with-surrogate-testing-1",
    "page": "Overview",
...
{
    "location": "#I-want-to-visualize-my-surrogate-realizations-1",
    "page": "Overview",
...
{
    "location": "man/whatisasurrogate/#What-is-a-surrogate?-1",
    "page": "What is a surrogate?",
    "title": "What is a surrogate?",
    "category": "section",
    "text": ""
...
{
    "location": "man/whatisasurrogate/#The-method-of-surrogate-testing-1",
    "page": "What is a surrogate?",
...
{
    "location": "man/whatisasurrogate/#What-is-a-surrogate-time-series?-1",
    "page": "What is a surrogate?",
...
{
    "location": "man/whatisasurrogate/#Types-of-surrogate-realizations-1",
    "page": "What is a surrogate?",
...
{
    "location": "man/whatisasurrogate/#Constrained-realizations-1",
    "page": "What is a surrogate?",
...
{
    "location": "man/whatisasurrogate/#Typical-realizations-1",
    "page": "What is a surrogate?",
...
{
    "location": "man/whatisasurrogate/#Literature-references-1",
    "page": "What is a surrogate?",
...
{
    "location": "constrained/randomshuffle/#",
...
{
    "location": "constrained/fourier_surrogates/#",
...
{
    "location": "constrained/fourier_surrogates/#Fourier-surrogates-(FS)-1",
    "page": "Fourier transform (FT)",
...
{
    "location": "constrained/fourier_surrogates/#TimeseriesSurrogates.randomphases",
    "page": "Fourier transform (FT)",
    "title": "TimeseriesSurrogates.randomphases",
    "category": "function",
    "text": "randomphases(ts::AbstractArray{T, 1} where T)\n\nCreate a random phases surrogate for ts     (Theiler et al., 1992). Surrogate realizations using the phase surrogates have the same linear correlation, or periodogram, as the original data.\n\nArguments\n\nts: the time series for which to generate the surrogate realization.\n\nReferences\n\nJ. Theiler et al., Physica D 58 (1992) 77-94 (1992). https://www.sciencedirect.com/science/article/pii/016727899290102S\n\n\n\n\n\n"
},

{
    "location": "constrained/fourier_surrogates/#Random-phase-surrogates-1",
    "page": "Fourier transform (FT)",
...
{
    "location": "constrained/fourier_surrogates/#How-do-random-phase-surrogates-vary-across-realizations?-1",
    "page": "Fourier transform (FT)",
...
{
    "location": "constrained/fourier_surrogates/#TimeseriesSurrogates.randomamplitudes",
    "page": "Fourier transform (FT)",
    "title": "TimeseriesSurrogates.randomamplitudes",
    "category": "function",
    "text": "randomamplitudes(ts::AbstractArray{T, 1} where T)\n\nCreate a random amplitude surrogate for ts.\n\nA modification of the random phases surrogates from Theiler et al., 1992 , where amplitudes are adjusted instead of the phases after taking the Fourier transform.\n\nArguments\n\nts`**: the time series for which to generate the surrogate realization.\n\nReferences\n\nJ. Theiler et al., Physica D 58 (1992) 77-94 (1992). https://www.sciencedirect.com/science/article/pii/016727899290102S\n\n\n\n\n\n"
},

{
    "location": "constrained/fourier_surrogates/#Random-amplitude-surrogates-1",
    "page": "Fourier transform (FT)",
...
{
    "location": "constrained/fourier_surrogates/#How-do-random-amplitude-surrogates-vary-across-realizations?-1",
    "page": "Fourier transform (FT)",
...
{
    "location": "constrained/amplitude_adjusted/#Amplitude-adjusted-Fourier-transform-surrogates-1",
    "page": "Amplitude adjusted Fourier (AAFT)",
...
{
    "location": "constrained/amplitude_adjusted/#TimeseriesSurrogates.aaft",
    "page": "Amplitude adjusted Fourier (AAFT)",
    "title": "TimeseriesSurrogates.aaft",
    "category": "function",
    "text": "aaft(ts::AbstractArray{T, 1} where T)\n\nGenerate a realization of an amplitude adjusted Fourier transform (AAFT) surrogate (Theiler et al., 1992).\n\nArguments\n\nts: the time series for which to generate the surrogate realization.\n\nReferences\n\nJ. Theiler et al., Physica D 58 (1992) 77-94 (1992). https://www.sciencedirect.com/science/article/pii/016727899290102S\n\n\n\n\n\n"
},

{
    "location": "constrained/amplitude_adjusted/#Amplitude-adjusted-Fourier-transform-(AAFT)-1",
    "page": "Amplitude adjusted Fourier (AAFT)",
...
{
    "location": "constrained/amplitude_adjusted/#Example-of-AAFT-1",
    "page": "Amplitude adjusted Fourier (AAFT)",
...
{
    "location": "constrained/amplitude_adjusted/#TimeseriesSurrogates.iaaft",
    "page": "Amplitude adjusted Fourier (AAFT)",
    "title": "TimeseriesSurrogates.iaaft",
    "category": "function",
    "text": "iaaft(ts::AbstractArray{T, 1} where T;\n        n_maxiter = 200, tol = 1e-6, n_windows = 50)\n\nGenerate an iteratively adjusted amplitude adjusted Fourier transform (IAAFT) (Schreiber & Schmitz, 1996) surrogate realization of ts.\n\nArguments\n\nts: the time series for which to generate an AAFT surrogate realization.\nn_maxiter: sets the maximum number of iterations to allow before ending   the algorithm (if convergence is slow).\ntol: the relative tolerance for deciding if convergence is achieved.\nn_window: the number is windows used when binning the periodogram (used   for determining convergence).\n\nReferences\n\nT. Schreiber; A. Schmitz (1996). \"Improved Surrogate Data for Nonlinearity Tests\". Phys. Rev. Lett. 77 (4): 635–638. doi:10.1103/PhysRevLett.77.635. PMID 10062864. https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.77.635\n\n\n\n\n\n"
},

{
    "location": "constrained/amplitude_adjusted/#Iterated-AAFT-(AAFT)-1",
    "page": "Amplitude adjusted Fourier (AAFT)",
...
{
    "location": "constrained/amplitude_adjusted/#Example-of-IAAFT-1",
    "page": "Amplitude adjusted Fourier (AAFT)",
...
{
    "location": "plots/visualize_surrogate/#",
...
{
    "location": "plots/visualize_surrogate/#Visualizing-surrogates-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#Autocorrelation-/-periodogram-panels-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#Animate-panels-(and-export-to-.gif)-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#Examples-1",
    "page": "Visualising surrogate realizations and creating gifs",
    "title": "Examples",
    "category": "section",
    "text": ""
...
{
    "location": "plots/visualize_surrogate/#IAAFT-realizations-of-an-AR1-process-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#IAAFT-realizations-of-a-NSAR2-process-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#Random-phase-realizations-of-a-random-walk-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomshuffle_plot",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomamplitudes_plot",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomphases_plot",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.aaft_plot",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.iaaft_plot",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomshuffle_anim",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomamplitudes_anim",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomphases_anim",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.aaft_anim",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.iaaft_anim",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomshuffle_gif",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomamplitudes_gif",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.randomphases_gif",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.aaft_gif",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#TimeseriesSurrogates.iaaft_gif",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "plots/visualize_surrogate/#Plot/animation/gif-docs-1",
    "page": "Visualising surrogate realizations and creating gifs",
...
{
    "location": "man/exampleprocesses/#TimeseriesSurrogates.NLNS",
    "page": "Example systems",
    "title": "TimeseriesSurrogates.NLNS",
    "category": "function",
    "text": "NLNS(n_steps, x₀)\n\nA nonlinear, nonstationary process.\n\nEquations\n\nThe systems is given by the following stochastic model:\n\nx(t+1) = x(t) + a(t) a(t-1)\n\nwith a(t) 	extasciitilde N(01) being stationary. The nonlinearity lies in the a(t) a(t-1) term. This is, in essence, a nonlinear random walk. x₀ sets the initial condition.\n\nThis example is from Lucio et al. (2012).\n\nReferences\n\nLucio et al., Phys. Rev. E 85, 056202 (2012), after J. Timmer, Phys. Rev. E 58, 5153 (1998). https://journals.aps.org/pre/abstract/10.1103/PhysRevE.85.056202\n\n\n\n\n\n"
},

{
    "location": "man/exampleprocesses/#TimeseriesSurrogates.SNLST",
    "page": "Example systems",
    "title": "TimeseriesSurrogates.SNLST",
    "category": "function",
    "text": "SNLST(n_steps, x₀, k)\n\nDynamically linear process transformed by a strongly nonlinear static transformation (SNLST), from Lucio et al., 2012.\n\nEquations\n\nThe system is by the following map:\n\nx(t) = k x(t-1) + a(t)\n\nwith the transformation s(t) = x(t)^3.\n\nReferences\n\nLucio et al., Phys. Rev. E 85, 056202 (2012), after J. Timmer, Phys. Rev. E 58, 5153 (1998).  https://journals.aps.org/pre/abstract/10.1103/PhysRevE.85.056202\n\n\n\n\n\n"
},

{
    "location": "man/exampleprocesses/#TimeseriesSurrogates.randomwalk",
    "page": "Example systems",
    "title": "TimeseriesSurrogates.randomwalk",
    "category": "function",
    "text": "randomwalk(n_steps, x₀)\n\nLinear random walk (AR(1) process with a unit root) from Lucio et al. (2012). This is an example of a nonstationary linear process.\n\nReferences\n\nLucio et al., Phys. Rev. E 85, 056202 (2012), after J. Timmer, Phys. Rev. E 58, 5153 (1998). https://journals.aps.org/pre/abstract/10.1103/PhysRevE.85.056202\n\n\n\n\n\n"
},

{
    "location": "man/exampleprocesses/#TimeseriesSurrogates.NSAR2",
    "page": "Example systems",
    "title": "TimeseriesSurrogates.NSAR2",
    "category": "function",
    "text": "NSAR2(n_steps, x₀, x₁)\n\nCyclostationary AR(2) process from Lucio et al. (2012).\n\nReferences\n\nLucio et al., Phys. Rev. E 85, 056202 (2012), after J. Timmer, Phys. Rev. E 58, 5153 (1998). https://journals.aps.org/pre/abstract/10.1103/PhysRevE.85.056202\n\n\n\n\n\n"
},

{
    "location": "man/exampleprocesses/#TimeseriesSurrogates.AR1",
    "page": "Example systems",
    "title": "TimeseriesSurrogates.AR1",
    "category": "function",
    "text": "AR1(n_steps, x₀, k)\n\nSimple AR(1) model with no static transformation from Lucio et al. (2012).\n\nEquations\n\nThe system is given by the following map [1]:\n\nx(t+1) = k x(t) + a(t)\n\nwhere a(t) is a draw from a normal distribution with zero mean and unit variance. x₀ sets the initial condition and k is the tunable parameter in the map.\n\nReferences\n\nLucio et al., Phys. Rev. E 85, 056202 (2012). https://journals.aps.org/pre/abstract/10.1103/PhysRevE.85.056202\n\n\n\n\n\n"
},

{
    "location": "man/exampleprocesses/#Example-processes-1",
    "page": "Example systems",
